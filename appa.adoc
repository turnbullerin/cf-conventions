...
The "Type" values are **S** for string, **L** for natural language strings suitable for localization (see Chapter 10), **N** for numeric, and **D** for the type of the data variable.
